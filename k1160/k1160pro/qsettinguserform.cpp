...
void QSettingUserForm::InitOCX()
{
    ...
    ui->pb_settinguser_pgup->setStyleSheet("QPushButton{background-color:transparent;background-image: url(./skin/default/bt_pgup_normal.png)}""QPushButton:hover{background-image: url(./skin/default/bt_pgup_normal.png);}""QPushButton:pressed{background-image: url(./skin/default/bt_pgup_press.png);}");
    ...
    ui->pb_settinguser_pgdn->setStyleSheet("QPushButton{background-color:transparent;background-image: url(./skin/default/bt_pgdn_normal.png)}""QPushButton:hover{background-image: url(./skin/default/bt_pgdn_normal.png);}""QPushButton:pressed{background-image: url(./skin/default/bt_pgdn_press.png);}");
    ...
    //ui->pb_settinguser_change->setStyleSheet("QPushButton{background-color:transparent;background-image: url(./skin/default/bt_delete_normal.png)}""QPushButton:hover{background-image: url(./skin/default/bt_delete_normal.png);}""QPushButton:pressed{background-image: url(./skin/default/bt_delete_press.png);}");
    ui->pb_settinguser_change->setStyleSheet("QPushButton{background-color:transparent;background-image: url(./skin/default/bt_pici_normal.png)}""QPushButton:hover{background-image: url(./skin/default/bt_pici_normal.png);}""QPushButton:pressed{background-image: url(./skin/default/bt_pici_press.png);}");
    ...
    ui->pb_settinguser_delete->setStyleSheet("QPushButton{background-color:transparent;background-image: url(./skin/default/bt_delete_normal.png)}""QPushButton:hover{background-image: url(./skin/default/bt_delete_normal.png);}""QPushButton:pressed{background-image: url(./skin/default/bt_delete_press.png);}");
    ...
    ui->pb_settinguser_add->setStyleSheet("QPushButton{background-color:transparent;background-image: url(./skin/default/bt_add_normal.png)}""QPushButton:hover{background-image: url(./skin/default/bt_add_normal.png);}""QPushButton:pressed{background-image: url(./skin/default/bt_add_press.png);}");
    ...
    ui->pb_settinguser_save->setStyleSheet("QPushButton{background-color:transparent;background-image: url(./skin/default/bt_save_normal.png)}""QPushButton:hover{background-image: url(./skin/default/bt_save_normal.png);}""QPushButton:pressed{background-image: url(./skin/default/bt_save_press.png);}");

    //
    ui->le_settinguser_name->setGeometry(564,72,291, 35);
    ui->le_settinguser_name->setStyleSheet("QLineEdit{background-color:transparent;}""QLineEdit{background-image: url(./skin/default/ed_line_big.png);font-size:17px}");
    //ui->le_settinguser_name->setEnabled(false);

    ui->le_settinguser_passwd->setGeometry(564,131,291, 35);
    ui->le_settinguser_passwd->setStyleSheet("QLineEdit{background-color:transparent;}""QLineEdit{background-image: url(./skin/default/ed_line_big.png);font-size:17px}");
    ...
    ui->le_settinguser_passwdcomfire->setStyleSheet("QLineEdit{background-color:transparent;}""QLineEdit{background-image: url(./skin/default/ed_line_big.png);font-size:17px}");
    ...
    ui->le_settinguser_people->setStyleSheet("QLineEdit{background-color:transparent;}""QLineEdit{background-image: url(./skin/default/ed_line_big.png);font-size:17px}");
    ...
    ui->le_settinguser_time->setStyleSheet("QLineEdit{background-color:transparent;}""QLineEdit{background-image: url(./skin/default/ed_line_big.png);font-size:17px}");
    ...
    ui->le_settinguser_note->setStyleSheet("QLineEdit{background-color:transparent;}""QLineEdit{background-image: url(./skin/default/ed_line_big.png);font-size:17px}");
...
#if 1
    QFile styleFile("://QQTWidgets.qss");
...
void QSettingUserForm::on_pb_settinguser_delete_clicked()
{
    ...
    if( QQTMsgBox::Rejected == QQTMsgBox::question(this, "确认删除用户？") )
        return;
