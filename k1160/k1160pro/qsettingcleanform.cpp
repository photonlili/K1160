    ...
    m_pSerialSettingClean(NULL)
{
    ...
    {
        m_pSerialSettingClean = K1160SerialInst(this);
    }
...
void QSettingCleanForm::InitOCX()
{
    ...
    ui->le_settingclean_xiaohuaguan->setStyleSheet("QLineEdit{background-color:transparent;}""QLineEdit{background-image: url(./skin/default/le_setting_enter.png);font-size:17px}");

    ui->le_settingclean_huansuan->setGeometry(698,146,  105, 45);
    ui->le_settingclean_huansuan->setText(m_ptc->toUnicode("2"));
    ui->le_settingclean_huansuan->setStyleSheet("QLineEdit{background-color:transparent;}""QLineEdit{background-image: url(./skin/default/le_setting_enter.png);font-size:17px}");

    ui->le_settingclean_jieshoubei->setGeometry(93,449,105, 45);
    ui->le_settingclean_jieshoubei->setText(m_ptc->toUnicode("2"));
    ui->le_settingclean_jieshoubei->setStyleSheet("QLineEdit{background-color:transparent;}""QLineEdit{background-image: url(./skin/default/le_setting_enter.png);font-size:17px}");

    ui->le_settingclean_jianguan->setGeometry(403,449,105, 45);
    ui->le_settingclean_jianguan->setText(m_ptc->toUnicode("2"));
    ui->le_settingclean_jianguan->setStyleSheet("QLineEdit{background-color:transparent;}""QLineEdit{background-image: url(./skin/default/le_setting_enter.png);font-size:17px}");

    ui->le_settingclean_pengsuanguan->setGeometry(698,449,105, 45);
    ui->le_settingclean_pengsuanguan->setText(m_ptc->toUnicode("2"));
    ui->le_settingclean_pengsuanguan->setStyleSheet("QLineEdit{background-color:transparent;}""QLineEdit{background-image: url(./skin/default/le_setting_enter.png);font-size:17px}");
    ...
    ui->pb_settingclean_save->setStyleSheet("QPushButton{background-color:transparent;background-image: url(./skin/default/bt_save_normal.png)}""QPushButton:hover{background-image: url(./skin/default/bt_save_normal.png);}""QPushButton:pressed{background-image: url(./skin/default/bt_save_press.png);}");
