    ...
    strtable("method")
{
    ...
    {
        m_pSerialManual = K1160SerialInst();
...
void QManualTestForm::InitOCX()
{
    ...
    ui->le_manualtest_pengsuan->setStyleSheet("QLineEdit{background-color:transparent;}""QLineEdit{background-image: url(./skin/default/ed_line_big.png);font-size:17px}");

    ui->le_manualtest_xishishui->setGeometry(157, y + dy * 1, 291, 35);
    ui->le_manualtest_xishishui->setStyleSheet("QLineEdit{background-color:transparent;}""QLineEdit{background-image: url(./skin/default/ed_line_big.png);font-size:17px}");

    ui->le_manualtest_jian->setGeometry(157, y + dy * 2, 291, 35);
    ui->le_manualtest_jian->setStyleSheet("QLineEdit{background-color:transparent;}""QLineEdit{background-image: url(./skin/default/ed_line_big.png);font-size:17px}");

    ui->le_manualtest_zhengliu->setGeometry(157, y + dy * 3, 188, 35);
    ui->le_manualtest_zhengliu->setStyleSheet("QLineEdit{background-color:transparent;}""QLineEdit{background-image: url(./skin/default/ed_line.png);font-size:17px}");

    ui->le_manualtest_diding->setGeometry(157, y + dy * 4,291, 35);
    ui->le_manualtest_diding->setStyleSheet("QLineEdit{background-color:transparent;}""QLineEdit{background-image: url(./skin/default/ed_line_big.png);font-size:17px}");
    ...
    m_pLbxiaohuaguanonoff->setStyleSheet("QLabel{background-color:transparent;}""QLabel{background-image: url(./skin/default/bt_off.png);}");

    m_pLbjieshoubeoonoff = new QMLabel(this);
    m_pLbjieshoubeoonoff->setGeometry(368,y + dy * 5 + ddy,78, 29);
    m_pLbjieshoubeoonoff->setStyleSheet("QLabel{background-color:transparent;}""QLabel{background-image: url(./skin/default/bt_no.png);}");

    ui->le_manualtest_mingcheng->setGeometry(157, y + dy * 0, 291, 35);
    ui->le_manualtest_mingcheng->setStyleSheet("QLineEdit{background-color:transparent;}""QLineEdit{background-image: url(./skin/default/ed_line_big.png);font-size:17px}");

    ui->le_manualtest_xishu->setGeometry(157, y + dy * 1,291, 35);
    ui->le_manualtest_xishu->setStyleSheet("QLineEdit{background-color:transparent;}""QLineEdit{background-image: url(./skin/default/ed_line_big.png);font-size:17px}");
    ...
    ui->le_manualtest_liuliang->setStyleSheet("QLineEdit{background-color:transparent;}""QLineEdit{background-image: url(./skin/default/ed_line_big.png);font-size:17px}");

    ui->le_enternumeber->setGeometry(629, 413, 223, 38);
    ui->le_enternumeber->setMargin(3);
    ui->le_enternumeber->setStyleSheet("QLabel{background-color:transparent;}""QLabel{background-image: url(./skin/default/ed_enterNumber.png);font-size:17px}");
    ...
    ui->pb_manualtest_clean->setStyleSheet("QPushButton{background-color:transparent;background-image: url(./skin/default/bt_clean_normal.png)}""QPushButton:hover{background-image: url(./skin/default/bt_clean_normal.png);}""QPushButton:pressed{background-image: url(./skin/default/bt_clean_press.png);}");
    ...
    ui->pb_manualtest_save->setStyleSheet("QPushButton{background-color:transparent;background-image: url(./skin/default/bt_save_normal.png)}""QPushButton:hover{background-image: url(./skin/default/bt_save_normal.png);}""QPushButton:pressed{background-image: url(./skin/default/bt_save_press.png);}");

    ui->pb_manualtest_1->setFlat(true);
   //ui->pb_manualtest_1->setFocusPolicy(Qt::NoFocus);
    ui->pb_manualtest_1->setGeometry(629,471,69,34);
    ui->pb_manualtest_1->setStyleSheet("QPushButton{background-color:transparent;background-image: url(./skin/default/btn_board1normal.png)}""QPushButton:hover{background-image: url(./skin/default/btn_board1normal.png);}""QPushButton:pressed{background-image: url(./skin/default/btn_board1press.png);}");


    ui->pb_manualtest_4->setFlat(true);
    //ui->pb_manualtest_4->setFocusPolicy(Qt::NoFocus);
    ui->pb_manualtest_4->setGeometry(629,518,69,34);
    ui->pb_manualtest_4->setStyleSheet("QPushButton{background-color:transparent;background-image: url(./skin/default/btn_board4normal.png)}""QPushButton:hover{background-image: url(./skin/default/btn_board4normal.png);}""QPushButton:pressed{background-image: url(./skin/default/btn_board4press.png);}");


    ui->pb_manualtest_7->setFlat(true);
    //ui->pb_manualtest_7->setFocusPolicy(Qt::NoFocus);
    ui->pb_manualtest_7->setGeometry(629,565,69,34);
    ui->pb_manualtest_7->setStyleSheet("QPushButton{background-color:transparent;background-image: url(./skin/default/btn_board7noraml.png)}""QPushButton:hover{background-image: url(./skin/default/btn_board7noraml.png);}""QPushButton:pressed{background-image: url(./skin/default/btn_board7press.png);}");


    ui->pb_manualtest_c->setFlat(true);
    //ui->pb_manualtest_c->setFocusPolicy(Qt::NoFocus);
    ui->pb_manualtest_c->setGeometry(629,613,69,34);
    ui->pb_manualtest_c->setStyleSheet("QPushButton{background-color:transparent;background-image: url(./skin/default/btn_cnormal.png)}""QPushButton:hover{background-image: url(./skin/default/btn_cnormal.png);}""QPushButton:pressed{background-image: url(./skin/default/btn_cpress.png);}");

    ui->pb_manualtest_2->setFlat(true);
    //ui->pb_manualtest_2->setFocusPolicy(Qt::NoFocus);
    ui->pb_manualtest_2->setGeometry(711,471,69,34);
    ui->pb_manualtest_2->setStyleSheet("QPushButton{background-color:transparent;background-image: url(./skin/default/btn_board2normal.png)}""QPushButton:hover{background-image: url(./skin/default/btn_board2normal.png);}""QPushButton:pressed{background-image: url(./skin/default/btn_board2press.png);}");


    ui->pb_manualtest_5->setFlat(true);
    //ui->pb_manualtest_5->setFocusPolicy(Qt::NoFocus);
    ui->pb_manualtest_5->setGeometry(711,518,69,34);
    ui->pb_manualtest_5->setStyleSheet("QPushButton{background-color:transparent;background-image: url(./skin/default/btn_board5normal.png)}""QPushButton:hover{background-image: url(./skin/default/btn_board5normal.png);}""QPushButton:pressed{background-image: url(./skin/default/btn_board5press.png);}");


    ui->pb_manualtest_8->setFlat(true);
    //ui->pb_manualtest_8->setFocusPolicy(Qt::NoFocus);
    ui->pb_manualtest_8->setGeometry(711,565,69,34);
    ui->pb_manualtest_8->setStyleSheet("QPushButton{background-color:transparent;background-image: url(./skin/default/btn_board8normal.png)}""QPushButton:hover{background-image: url(./skin/default/btn_board8normal.png);}""QPushButton:pressed{background-image: url(./skin/default/btn_board8press.png);}");


    ui->pb_manualtest_0->setFlat(true);
    //ui->pb_manualtest_0->setFocusPolicy(Qt::NoFocus);
    ui->pb_manualtest_0->setGeometry(711,613,69,34);
    ui->pb_manualtest_0->setStyleSheet("QPushButton{background-color:transparent;background-image: url(./skin/default/btn_board0normal.png)}""QPushButton:hover{background-image: url(./skin/default/btn_board0normal.png);}""QPushButton:pressed{background-image: url(./skin/default/btn_board0press.png);}");


    ui->pb_manualtest_3->setFlat(true);
    //ui->pb_manualtest_3->setFocusPolicy(Qt::NoFocus);
    ui->pb_manualtest_3->setGeometry(790,471,69,34);
    ui->pb_manualtest_3->setStyleSheet("QPushButton{background-color:transparent;background-image: url(./skin/default/btn_board3normal.png)}""QPushButton:hover{background-image: url(./skin/default/btn_board3normal.png);}""QPushButton:pressed{background-image: url(./skin/default/btn_board3press.png);}");


    ui->pb_manualtest_6->setFlat(true);
    //ui->pb_manualtest_6->setFocusPolicy(Qt::NoFocus);
    ui->pb_manualtest_6->setGeometry(790,518,69,34);
    ui->pb_manualtest_6->setStyleSheet("QPushButton{background-color:transparent;background-image: url(./skin/default/btn_board6normal.png)}""QPushButton:hover{background-image: url(./skin/default/btn_board6normal.png);}""QPushButton:pressed{background-image: url(./skin/default/btn_board6press.png);}");

    ui->pb_manualtest_9->setFlat(true);
    //ui->pb_manualtest_9->setFocusPolicy(Qt::NoFocus);
    ui->pb_manualtest_9->setGeometry(790,565,69,34);
    ui->pb_manualtest_9->setStyleSheet("QPushButton{background-color:transparent;background-image: url(./skin/default/btn_board9normal.png)}""QPushButton:hover{background-image: url(./skin/default/btn_board9normal.png);}""QPushButton:pressed{background-image: url(./skin/default/btn_board9press.png);}");
    ...
    ui->pb_manualtest_ok->setStyleSheet("QPushButton{background-color:transparent;background-image: url(./skin/default/btn_oknormal.png)}""QPushButton:hover{background-image: url(./skin/default/btn_oknormal.png);}""QPushButton:pressed{background-image: url(./skin/default/btn_okpress.png);}");
    ...
    m_plbcheckpengsuan->setStyleSheet("QLabel{background-color:transparent;}""QLabel{background-image: url(./skin/default/bt_check_normal.png);}");


    m_plbcheckjian = new QMLabel(this);
    m_plbcheckjian->setGeometry(836,269,39, 39);
    m_plbcheckjian->setStyleSheet("QLabel{background-color:transparent;}""QLabel{background-image: url(./skin/default/bt_check_normal.png);}");


    m_plbcheckxishishui = new QMLabel(this);
    m_plbcheckxishishui->setGeometry(689,315,39, 39);
    m_plbcheckxishishui->setStyleSheet("QLabel{background-color:transparent;}""QLabel{background-image: url(./skin/default/bt_check_normal.png);}");


    m_plbcheckdiding = new QMLabel(this);
    m_plbcheckdiding->setGeometry(836,315,39, 39);
    m_plbcheckdiding->setStyleSheet("QLabel{background-color:transparent;}""QLabel{background-image: url(./skin/default/bt_check_normal.png);}");


    m_plbcheckzhengliu = new QMLabel(this);
    m_plbcheckzhengliu->setGeometry(689,361,39, 39);
    m_plbcheckzhengliu->setStyleSheet("QLabel{background-color:transparent;}""QLabel{background-image: url(./skin/default/bt_check_normal.png);}");


    m_pLbpengsuantong = new QMLabel(this);
    //m_pLbpengsuantong->setFocusPolicy(Qt::NoFocus);
    m_pLbpengsuantong->setGeometry(626, 56,40, 40);
    m_pLbpengsuantong->setStyleSheet("QLabel{background-color:transparent;}""QLabel{background-image: url(./skin/default/lab_pengsuantong_normal.png);}");

    m_pLbshuitong = new QMLabel(this);
    //m_pLbshuitong->setFocusPolicy(Qt::NoFocus);
    m_pLbshuitong->setGeometry( 685,  56, 40, 40);
    m_pLbshuitong->setStyleSheet("QLabel{background-color:transparent;}""QLabel{background-image: url(./skin/default/lab_shuitong_normal.png);}");

    m_pLbjiantong = new QMLabel(this);
    //m_pLbjiantong->setFocusPolicy(Qt::NoFocus);
    m_pLbjiantong->setGeometry(744, 56,40, 40);
    m_pLbjiantong->setStyleSheet("QLabel{background-color:transparent;}""QLabel{background-image: url(./skin/default/lab_jiantong_normal.png);}");
    ...
    m_pLbdidingsuantong->setStyleSheet("QLabel{background-color:transparent;}""QLabel{background-image: url(./skin/default/lab_didingsuantong_normal.png);}");


    m_pLbzhengqifashengqiyewei = new QMLabel(this);
    m_pLbzhengqifashengqiyewei->setGeometry(626, 106,40, 40);
    m_pLbzhengqifashengqiyewei->setStyleSheet("QLabel{background-color:transparent;}""QLabel{background-image: url(./skin/default/lab_zhengqifashengqiyewei_normal.png);}");

    m_pLbanquanmen = new QMLabel(this);
    m_pLbanquanmen->setGeometry(685, 106,40, 40);
    m_pLbanquanmen->setStyleSheet("QLabel{background-color:transparent;}""QLabel{background-image: url(./skin/default/lab_anquanmen_normal.png);}");

    m_pLbxiaohuaguan = new QMLabel(this);
    m_pLbxiaohuaguan->setGeometry(744, 106,40, 40);
    m_pLbxiaohuaguan->setStyleSheet("QLabel{background-color:transparent;}""QLabel{background-image: url(./skin/default/lab_xiaohuaguan_normal.png);}");

    m_pLbfeiyetong = new QMLabel(this);
    //m_pLbfeiyetong->setFocusPolicy(Qt::NoFocus);
    m_pLbfeiyetong->setGeometry(803, 106,40, 40);
    m_pLbfeiyetong->setStyleSheet("QLabel{background-color:transparent;}""QLabel{background-image: url(./skin/default/lab_feiyetong_normal.png);}");
    ...
    m_pLbzhengqifashengqi->setStyleSheet("QLabel{background-color:transparent;}""QLabel{background-image: url(./skin/default/lab_zhengqifashengqi_normal.png);}");
    ...
    m_pLblengningshui->setStyleSheet("QLabel{background-color:transparent;}""QLabel{background-image: url(./skin/default/lab_lengningshui_normal.png);}");
...
void QManualTestForm::StateSensor(QByteArray pData)
{
     ...
     if(1 == ibool)
     {
         m_pLbfeiyetong->setStyleSheet("QLabel{background-color:transparent;}""QLabel{background-image: url(./skin/default/lab_feiyetong_press.png);}");
     }
     else
     {
         m_pLbfeiyetong->setStyleSheet("QLabel{background-color:transparent;}""QLabel{background-image: url(./skin/default/lab_feiyetong_normal.png);}");
     ...
     if(1 == ibool)
     {
         m_pLbdidingsuantong->setStyleSheet("QLabel{background-color:transparent;}""QLabel{background-image: url(./skin/default/lab_didingsuantong_press.png);}");
     }
     else
     {
         m_pLbdidingsuantong->setStyleSheet("QLabel{background-color:transparent;}""QLabel{background-image: url(./skin/default/lab_didingsuantong_normal.png);}");
     ...
     if(1 == ibool)
     {
         m_pLbpengsuantong->setStyleSheet("QLabel{background-color:transparent;}""QLabel{background-image: url(./skin/default/lab_pengsuantong_press.png);}");
     }
     else
     {
         m_pLbpengsuantong->setStyleSheet("QLabel{background-color:transparent;}""QLabel{background-image: url(./skin/default/lab_pengsuantong_normal.png);}");
     ...
     if(1 == ibool)
     {
         m_pLbjiantong->setStyleSheet("QLabel{background-color:transparent;}""QLabel{background-image: url(./skin/default/lab_jiantong_press.png);}");
     }
     else
     {
         m_pLbjiantong->setStyleSheet("QLabel{background-color:transparent;}""QLabel{background-image: url(./skin/default/lab_jiantong_normal.png);}");
     ...
     if(1 == ibool)
     {
         m_pLbshuitong->setStyleSheet("QLabel{background-color:transparent;}""QLabel{background-image: url(./skin/default/lab_shuitong_press.png);}");
     }
     else
     {
         m_pLbshuitong->setStyleSheet("QLabel{background-color:transparent;}""QLabel{background-image: url(./skin/default/lab_shuitong_normal.png);}");
     ...
     if(1 == ibool)
     {
         m_pLblengningshui->setStyleSheet("QLabel{background-color:transparent;}""QLabel{background-image: url(./skin/default/lab_lengningshui_press.png);}");
     }
     else
     {
         m_pLblengningshui->setStyleSheet("QLabel{background-color:transparent;}""QLabel{background-image: url(./skin/default/lab_lengningshui_normal.png);}");
     ...
     if(1 == ibool)
     {
         m_pLbzhengqifashengqi->setStyleSheet("QLabel{background-color:transparent;}""QLabel{background-image: url(./skin/default/lab_zhengqifashengqi_press.png);}");
     }
     else
     {
         m_pLbzhengqifashengqi->setStyleSheet("QLabel{background-color:transparent;}""QLabel{background-image: url(./skin/default/lab_zhengqifashengqi_normal.png);}");
     ...
     if(1 == ibool)
     {
         m_pLbzhengqifashengqiyewei->setStyleSheet("QLabel{background-color:transparent;}""QLabel{background-image: url(./skin/default/lab_zhengqifashengqiyewei_press.png);}");
     }
     else
     {
         m_pLbzhengqifashengqiyewei->setStyleSheet("QLabel{background-color:transparent;}""QLabel{background-image: url(./skin/default/lab_zhengqifashengqiyewei_normal.png);}");
     ...
     if(1 == ibool)
     {
         m_pLbanquanmen->setStyleSheet("QLabel{background-color:transparent;}""QLabel{background-image: url(./skin/default/lab_anquanmen_press.png);}");
     }
     else
     {
         m_pLbanquanmen->setStyleSheet("QLabel{background-color:transparent;}""QLabel{background-image: url(./skin/default/lab_anquanmen_normal.png);}");
     ...
     if(1 == ibool)
     {
         m_pLbxiaohuaguan->setStyleSheet("QLabel{background-color:transparent;}""QLabel{background-image: url(./skin/default/lab_xiaohuaguan_press.png);}");
     }
     else
     {
         m_pLbxiaohuaguan->setStyleSheet("QLabel{background-color:transparent;}""QLabel{background-image: url(./skin/default/lab_xiaohuaguan_normal.png);}");
...
void QManualTestForm::xiaohuaguan()
{
    ...
    {
        m_pLbxiaohuaguanonoff->setStyleSheet("QLabel{background-color:transparent;}""QLabel{background-image: url(./skin/default/bt_no.png);}");
...
void QManualTestForm::jieshoubei()
{
    ...
    {
        m_pLbjieshoubeoonoff->setStyleSheet("QLabel{background-color:transparent;}""QLabel{background-image: url(./skin/default/bt_off.png);}");
    }
...
void QManualTestForm::checkpengsuan()
{
    if(true == m_blbcheckpengsuan)
     {
        m_plbcheckpengsuan->setStyleSheet("QLabel{background-color:transparent;}""QLabel{background-image: url(./skin/default/bt_check_press.png);}");
    ...
    if(true == m_blbcheckjian)
     {
        ...
        m_plbcheckjian->setStyleSheet("QLabel{background-color:transparent;}""QLabel{background-image: url(./skin/default/bt_check_press.png);}");
    ...
    if(true == m_blbcheckxishishui)
     {
        ...
        m_plbcheckxishishui->setStyleSheet("QLabel{background-color:transparent;}""QLabel{background-image: url(./skin/default/bt_check_press.png);}");
    ...
    if(true == m_blbcheckdiding)
     {
        ...
        m_plbcheckdiding->setStyleSheet("QLabel{background-color:transparent;}""QLabel{background-image: url(./skin/default/bt_check_press.png);}");
    ...
    if(true == m_blbcheckzhengliu)
     {
        ...
        m_plbcheckzhengliu->setStyleSheet("QLabel{background-color:transparent;}""QLabel{background-image: url(./skin/default/bt_check_press.png);}");
