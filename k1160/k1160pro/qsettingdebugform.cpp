    ...
    m_pStateDebugTimer(NULL)
{
    ...
    {
        m_pSerialDebug = K1160SerialInst();
    }
...
void QSettingDebugForm::InitOCX()
{
    ...
    ui->ed_settingdebug_zheqi->setStyleSheet("QLineEdit{background-color:transparent;}""QLineEdit{background-image: url(./skin/default/ed_line_small.png);font-size:17px}");
    ...
    ui->ed_settingdebug_lengning->setStyleSheet("QLineEdit{background-color:transparent;}""QLineEdit{background-image: url(./skin/default/ed_line_small.png);font-size:17px}");
    ui->ed_settingdebug_lengning->setHidden(true);

    ui->ed_settingdebug_r->setGeometry(226,363,107, 35);
    ui->ed_settingdebug_r->setStyleSheet("QLineEdit{background-color:transparent;}""QLineEdit{background-image: url(./skin/default/ed_line_small.png);font-size:17px}");
    ui->ed_settingdebug_r->setText("");

    ui->ed_settingdebug_g->setGeometry(226,405,104, 35);
    ui->ed_settingdebug_g->setStyleSheet("QLineEdit{background-color:transparent;}""QLineEdit{background-image: url(./skin/default/ed_line_small.png);font-size:17px}");
    ui->ed_settingdebug_g->setText("");

    ui->ed_settingdebug_b->setGeometry(226,447,107, 35);
    ui->ed_settingdebug_b->setStyleSheet("QLineEdit{background-color:transparent;}""QLineEdit{background-image: url(./skin/default/ed_line_small.png);font-size:17px}");
    ui->ed_settingdebug_b->setText("");

    ui->le_settingdebug_c->setGeometry(226,493,107, 35);
    ui->le_settingdebug_c->setStyleSheet("QLineEdit{background-color:transparent;}""QLineEdit{background-image: url(./skin/default/ed_line_small.png);font-size:17px}");
    ...
    m_plbjiashuibeng->setStyleSheet("QLabel{background-color:transparent;}""QLabel{background-image: url(./skin/default/bt_no.png);}");

    m_plbsantongfa = new QMLabel(this);
    m_plbsantongfa->setGeometry(696,103,78, 29);
    m_plbsantongfa->setStyleSheet("QLabel{background-color:transparent;}""QLabel{background-image: url(./skin/default/bt_no.png);}");

    m_plbqingxibeng = new QMLabel(this);
    m_plbqingxibeng->setGeometry(608,142,78, 29);
    m_plbqingxibeng->setStyleSheet("QLabel{background-color:transparent;}""QLabel{background-image: url(./skin/default/bt_no.png);}");

    m_plbpengsuanbeng = new QMLabel(this);
    m_plbpengsuanbeng->setGeometry(782,142,78, 29);
    m_plbpengsuanbeng->setStyleSheet("QLabel{background-color:transparent;}""QLabel{background-image: url(./skin/default/bt_no.png);}");

    m_plbpaifeifa = new QMLabel(this);
    m_plbpaifeifa->setGeometry(608,181,78, 29);
    m_plbpaifeifa->setStyleSheet("QLabel{background-color:transparent;}""QLabel{background-image: url(./skin/default/bt_no.png);}");

    m_plbjiaguanfa = new QMLabel(this);
    m_plbjiaguanfa->setGeometry(782,181,78, 29);
    m_plbjiaguanfa->setStyleSheet("QLabel{background-color:transparent;}""QLabel{background-image: url(./skin/default/bt_no.png);}");

    m_plbjiaobanji = new QMLabel(this);
    m_plbjiaobanji->setGeometry(608,220,78, 29);
    m_plbjiaobanji->setStyleSheet("QLabel{background-color:transparent;}""QLabel{background-image: url(./skin/default/bt_no.png);}");

    m_plbyanseled = new QMLabel(this);
    m_plbyanseled->setGeometry(782,220,78, 29);
    m_plbyanseled->setStyleSheet("QLabel{background-color:transparent;}""QLabel{background-image: url(./skin/default/bt_no.png);}");

    m_plbjieshoubeipaifeifa = new QMLabel(this);
    m_plbjieshoubeipaifeifa->setGeometry(608,259,78, 29);
    m_plbjieshoubeipaifeifa->setStyleSheet("QLabel{background-color:transparent;}""QLabel{background-image: url(./skin/default/bt_no.png);}");

    m_plbjianbeng = new QMLabel(this);
    m_plbjianbeng->setGeometry(782,259,78, 29);
    m_plbjianbeng->setStyleSheet("QLabel{background-color:transparent;}""QLabel{background-image: url(./skin/default/bt_no.png);}");

    m_plblengningshuijinshuifa = new QMLabel(this);
    m_plblengningshuijinshuifa->setGeometry(608,298,78, 29);
    m_plblengningshuijinshuifa->setStyleSheet("QLabel{background-color:transparent;}""QLabel{background-image: url(./skin/default/bt_no.png);}");

    //蒸汽
    m_plbzhengqisantongfa = new QMLabel(this);
    m_plbzhengqisantongfa->setGeometry(782,298,78, 29);
    m_plbzhengqisantongfa->setStyleSheet("QLabel{background-color:transparent;}""QLabel{background-image: url(./skin/default/bt_no.png);}");

    //蒸馏
    m_plbjieshoubeipaifeibeng = new QMLabel(this);
    m_plbjieshoubeipaifeibeng->setGeometry(608,337,78, 29);
    m_plbjieshoubeipaifeibeng->setStyleSheet("QLabel{background-color:transparent;}""QLabel{background-image: url(./skin/default/bt_no.png);}");

    m_plbdidingsantongfa = new QMLabel(this);
    m_plbdidingsantongfa->setGeometry(608,298,78, 29);
    m_plbdidingsantongfa->setStyleSheet("QLabel{background-color:transparent;}""QLabel{background-image: url(./skin/default/bt_no.png);}");
    m_plbdidingsantongfa->hide();

    m_plbzhaopmingled = new QMLabel(this);
    m_plbzhaopmingled->setGeometry(782,298,78, 29);
    m_plbzhaopmingled->setStyleSheet("QLabel{background-color:transparent;}""QLabel{background-image: url(./skin/default/bt_no.png);}");
    ...
    ui->pb_zhusaibengup->setStyleSheet("QPushButton{background-color:transparent;background-image: url(./skin/default/btn_upnormal.png)}""QPushButton:hover{background-image: url(./skin/default/btn_upnormal.png);}""QPushButton:pressed{background-image: url(./skin/default/btn_uppress.png);}");
    ...
    ui->pb_zhusaibengdown->setStyleSheet("QPushButton{background-color:transparent;background-image: url(./skin/default/btn_downnormal.png)}""QPushButton:hover{background-image: url(./skin/default/btn_downnormal.png);}""QPushButton:pressed{background-image: url(./skin/default/btn_downpress.png);}");
...
void QSettingDebugForm::jianshuibeng()
{
    if(true == m_bjianshuibeng)
     {
         m_plbjiashuibeng->setStyleSheet("QLabel{background-color:transparent;}""QLabel{background-image: url(./skin/default/bt_off.png);}");
...
void QSettingDebugForm::suantongfa()
{
    if(true == m_bsuantongfa)
     {
         m_plbsantongfa->setStyleSheet("QLabel{background-color:transparent;}""QLabel{background-image: url(./skin/default/bt_off.png);}");
         m_bsuantongfa = false;
     }
     else
     {
...
void QSettingDebugForm::qingxibeng()
{
    if(true == m_bqingxibeng)
     {
         m_plbqingxibeng->setStyleSheet("QLabel{background-color:transparent;}""QLabel{background-image: url(./skin/default/bt_off.png);}");
         m_bqingxibeng = false;
     }
     else
     {
...
void QSettingDebugForm::pengsuanbeng()
{
    if(true == m_bpengsuanbeng)
     {
         m_plbpengsuanbeng->setStyleSheet("QLabel{background-color:transparent;}""QLabel{background-image: url(./skin/default/bt_off.png);}");
...
void QSettingDebugForm::paifeifa()
{
    if(true == m_bpaifeifa)
     {
         m_plbpaifeifa->setStyleSheet("QLabel{background-color:transparent;}""QLabel{background-image: url(./skin/default/bt_off.png);}");
         m_bpaifeifa = false;
     }
     else
     {
...
void QSettingDebugForm::jianguanfa()
{
    if(true == m_bjianguanfa)
     {
         m_plbjiaguanfa->setStyleSheet("QLabel{background-color:transparent;}""QLabel{background-image: url(./skin/default/bt_off.png);}");
         m_bjianguanfa = false;
     }
     else
     {
...
void QSettingDebugForm::jiaobanji()
{
    if(true == m_bjiaobanji)
     {
         m_plbjiaobanji->setStyleSheet("QLabel{background-color:transparent;}""QLabel{background-image: url(./skin/default/bt_off.png);}");
         m_bjiaobanji = false;
     }
     else
     {
...
void QSettingDebugForm::yanseled()
{
    if(true == m_byanseled)
     {
         m_plbyanseled->setStyleSheet("QLabel{background-color:transparent;}""QLabel{background-image: url(./skin/default/bt_off.png);}");
         m_byanseled = false;
     }
     else
     {
...
void QSettingDebugForm::zhengqisantongfa()
{
    if(true == m_bzhengqisantongfa)
     {
         m_plbzhengqisantongfa->setStyleSheet("QLabel{background-color:transparent;}""QLabel{background-image: url(./skin/default/bt_off.png);}");
...
void QSettingDebugForm::jianbeng()
{
    if(true == m_bjianbeng)
     {
         m_plbjianbeng->setStyleSheet("QLabel{background-color:transparent;}""QLabel{background-image: url(./skin/default/bt_off.png);}");
         m_bjianbeng = false;
     }
     else
     {
...
void QSettingDebugForm::didingsantongfa()
{
    if(true == m_bdidingsantongfa)
     {
         m_plbdidingsantongfa->setStyleSheet("QLabel{background-color:transparent;}""QLabel{background-image: url(./skin/default/bt_off.png);}");
...
void QSettingDebugForm::zhaomingled()
{
    if(true == m_bzhaomingled)
     {
         m_plbzhaopmingled->setStyleSheet("QLabel{background-color:transparent;}""QLabel{background-image: url(./skin/default/bt_off.png);}");
...
void QSettingDebugForm::jieshoubeioaifeibeng()
{
    if(true == m_bjieshoubeioaifeibeng)
     {
         m_plbjieshoubeipaifeibeng->setStyleSheet("QLabel{background-color:transparent;}""QLabel{background-image: url(./skin/default/bt_off.png);}");
...
void QSettingDebugForm::jieshoubeipaifeifa()
{
    if(true == m_bjieshoubeipaifeifa)
     {
         m_plbjieshoubeipaifeifa->setStyleSheet("QLabel{background-color:transparent;}""QLabel{background-image: url(./skin/default/bt_off.png);}");
...
void QSettingDebugForm::lengningshuijinshuifa()
{
    if(true == m_blengningshuijinshuifa)
     {
         m_plblengningshuijinshuifa->setStyleSheet("QLabel{background-color:transparent;}""QLabel{background-image: url(./skin/default/bt_off.png);}");
