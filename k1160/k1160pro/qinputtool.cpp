...
void QInputTool::InitStyle()
{
    ...
    QPalette palette;
    QPixmap pixmap("./skin/default/keyboardw.png");
...
void QInputTool::focusChanged(QWidget *oldWidget, QWidget *nowWidget)
{
    ...
    if (nowWidget != 0 && !this->isAncestorOf(nowWidget)) {
        ...
        if (currentPosition == "center") {
            ...
            if(ih > 768 && ih2 > 768)
                //up
                this->setGeometry(( QQT_SCRN_WIDTH - frmWidth) / 2, 0, frmWidth, frmRealHeight);
            else
                //down
                this->setGeometry(( QQT_SCRN_WIDTH - frmWidth) / 2,
                                  ( QQT_SCRN_HEIGHT - frmRealHeight),
