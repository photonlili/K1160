...
void QSettingMachineForm::InitOCX()
{
    ...
    m_plbjiandan->setStyleSheet("QLabel{background-color:transparent;}""QLabel{background-image: url(./skin/default/bt_check_press.png);}");
    m_bjiandan = false;
    m_plbjiandan->hide();
    ...
    m_plbxiangxi->setStyleSheet("QLabel{background-color:transparent;}""QLabel{background-image: url(./skin/default/bt_check_normal.png);}");
    m_plbxiangxi->hide();
    ...
    if(value ==0)
    {
        m_plbzijian->setStyleSheet("QLabel{background-color:transparent;}""QLabel{background-image: url(./skin/default/bt_off.png);}");
    }
    else
        m_plbzijian->setStyleSheet("QLabel{background-color:transparent;}""QLabel{background-image: url(./skin/default/bt_no.png);}");
    ...
    if(value ==0)
    {
        m_plblengningshui->setStyleSheet("QLabel{background-color:transparent;}""QLabel{background-image: url(./skin/default/bt_off.png);}");
    }
    else
        m_plblengningshui->setStyleSheet("QLabel{background-color:transparent;}""QLabel{background-image: url(./skin/default/bt_no.png);}");
    ...
    ui->pb_setttingmatchine_save->setStyleSheet("QPushButton{background-color:transparent;background-image: url(./skin/default/bt_save_normal.png)}""QPushButton:hover{background-image: url(./skin/default/bt_save_normal.png);}""QPushButton:pressed{background-image: url(./skin/default/bt_save_press.png);}");
    ...
    ui->le_settingmachine_xishu->setStyleSheet("QLineEdit{background-color:transparent;}""QLineEdit{background-image: url(./skin/default/ed_line.png);}");
   ...
   // ui->le_settingmachine_fangfaxishu->setStyleSheet("QLineEdit{background-color:transparent;}""QLineEdit{background-image: url(./skin/default/ed_line.png);}");

    QString str = set.value("dingbiaoxishu", 23).toString();
...
void QSettingMachineForm::jiandan()
{
    if(true == m_bjiandan)
     ...
     {
        m_plbjiandan->setStyleSheet("QLabel{background-color:transparent;}""QLabel{background-image: url(./skin/default/bt_check_normal.png);}");
        m_bjiandan = true;
     }
}
...
void QSettingMachineForm::xiangxi()
{
    if(true == m_bxiangxi)
     {
        m_plbxiangxi->setStyleSheet("QLabel{background-color:transparent;}""QLabel{background-image: url(./skin/default/bt_check_press.png);}");
        m_bxiangxi = false;
        m_plbjiandan->setStyleSheet("QLabel{background-color:transparent;}""QLabel{background-image: url(./skin/default/bt_check_normal.png);}");
        m_bjiandan = true;
     }
