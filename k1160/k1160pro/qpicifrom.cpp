...
void QPiciFrom::InitOCX()
{
    ...
    ui->ed_pici_name->setStyleSheet("QLineEdit{background-color:transparent;}""QLineEdit{background-image: url(./skin/default/ed_line_big.png);font-size:17px}");

    ui->ed_pici_shuliang->hide();
    //ui->ed_pici_shuliang->setGeometry(137, 204, 287, 31);
    //ui->ed_pici_shuliang->setStyleSheet("QLineEdit{background-color:transparent;}""QLineEdit{background-image: url(./skin/default/ed_line_big.png);font-size:17px}");

    ui->ed_pici_tiji->setGeometry(137, 372, 291, 35);
    ui->ed_pici_tiji->setStyleSheet("QLineEdit{background-color:transparent;}""QLineEdit{background-image: url(./skin/default/ed_line_big.png);font-size:17px}");

    ui->ed_pici_suannongdu->setGeometry(137, 428,291, 35);
    ui->ed_pici_suannongdu->setStyleSheet("QLineEdit{background-color:transparent;}""QLineEdit{background-image: url(./skin/default/ed_line_big.png);font-size:17px}");
    ...
    ui->pb_pici_pgup->setStyleSheet("QPushButton{background-color:transparent;background-image: url(./skin/default/bt_pgup_normal.png)}""QPushButton:hover{background-image: url(./skin/default/bt_pgup_normal.png);}""QPushButton:pressed{background-image: url(./skin/default/bt_pgup_press.png);}");

    ui->pb_pici_pgdn->setFlat(true);
    ui->pb_pici_pgdn->setFocusPolicy(Qt::NoFocus);
    ui->pb_pici_pgdn->setGeometry(271,599,108,44);
    ui->pb_pici_pgdn->setStyleSheet("QPushButton{background-color:transparent;background-image: url(./skin/default/bt_pgdn_normal.png)}""QPushButton:hover{background-image: url(./skin/default/bt_pgdn_normal.png);}""QPushButton:pressed{background-image: url(./skin/default/bt_pgdn_press.png);}");
    */
    ...
    ui->pb_pici_save->setStyleSheet("QPushButton{background-color:transparent;background-image: url(./skin/default/bt_save_normal.png)}""QPushButton:hover{background-image: url(./skin/default/bt_save_normal.png);}""QPushButton:pressed{background-image: url(./skin/default/bt_save_press.png);}");

    ui->pb_pici_delete->setFlat(true);
    //ui->pb_pici_delete->setFocusPolicy(Qt::NoFocus);
    ui->pb_pici_delete->setGeometry(384,599,108,44);
    ui->pb_pici_delete->setStyleSheet("QPushButton{background-color:transparent;background-image: url(./skin/default/bt_delete_normal.png)}""QPushButton:hover{background-image: url(./skin/default/bt_delete_normal.png);}""QPushButton:pressed{background-image: url(./skin/default/bt_delete_press.png);}");

    ui->pb_pici_back->setFlat(true);
    //ui->pb_pici_back->setFocusPolicy(Qt::NoFocus);
    ui->pb_pici_back->setGeometry(570,599,108,44);
    ui->pb_pici_back->setStyleSheet("QPushButton{background-color:transparent;background-image: url(./skin/default/bt_back_normal.png)}""QPushButton:hover{background-image: url(./skin/default/bt_back_normal.png);}""QPushButton:pressed{background-image: url(./skin/default/bt_back_press.png);}");
