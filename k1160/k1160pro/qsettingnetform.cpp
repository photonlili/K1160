...
void QSettingNetForm::InitOCX()
{
    ...
    ui->ed_settingnet_ip->setStyleSheet("QLineEdit{background-color:transparent;}""QLineEdit{background-image: url(./skin/default/ed_line_big.png);font-size:17px}");
    ...
    ui->ed_settingnet_mask->setStyleSheet("QLineEdit{background-color:transparent;}""QLineEdit{background-image: url(./skin/default/ed_line_big.png);font-size:17px}");
    ...
    ui->ed_settingnet_getway->setStyleSheet("QLineEdit{background-color:transparent;}""QLineEdit{background-image: url(./skin/default/ed_line_big.png);font-size:17px}");
    ...
    ui->ed_settingnet_dns->setStyleSheet("QLineEdit{background-color:transparent;}""QLineEdit{background-image: url(./skin/default/ed_line_big.png);font-size:17px}");
    ...
    ui->pb_zhixing->setStyleSheet("QPushButton{background-color:transparent;background-image: url(./skin/default/bt_start_normal.png)}""QPushButton:hover{background-image: url(./skin/default/bt_start_normal.png);}""QPushButton:pressed{background-image: url(./skin/default/bt_start_press.png);}");

    ui->m_pwifi->setGeometry(51, 233, 287, 177);

    m_pwifiManager = QQTEthenetManager::Instance(this);
    ...
    m_pDHCP->setStyleSheet("QLabel{background-color:transparent;}""QLabel{background-image: url(./skin/default/bt_check_normal.png);}");
...
void QSettingNetForm::InitSings()
{
    ...
    connect(QQTEthenetManager::Instance(), SIGNAL(sigConnected()), this, SLOT(NetChanged()));
    connect(QQTEthenetManager::Instance(), SIGNAL(sigDisConnected()), this, SLOT(NetChanged()));
...
void QSettingNetForm::dhcp()
{
    if(true == m_bDHCP)
     {
        m_pDHCP->setStyleSheet("QLabel{background-color:transparent;}""QLabel{background-image: url(./skin/default/bt_check_press.png);}");
        m_bDHCP = false;
