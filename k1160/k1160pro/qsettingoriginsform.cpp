...
void QSettingOriginsForm::InitOCX()
{
    ...
    ui->pb_pgup->setStyleSheet("QPushButton{background-color:transparent;background-image: url(./skin/default/bt_pgup_normal.png)}""QPushButton:hover{background-image: url(./skin/default/bt_pgup_normal.png);}""QPushButton:pressed{background-image: url(./skin/default/bt_pgup_press.png);}");

    ui->pb_pgdn->setFlat(true);
    ui->pb_pgdn->setFocusPolicy(Qt::NoFocus);
    ui->pb_pgdn->setGeometry(500,578,108,44);
    ui->pb_pgdn->setStyleSheet("QPushButton{background-color:transparent;background-image: url(./skin/default/bt_pgdn_normal.png)}""QPushButton:hover{background-image: url(./skin/default/bt_pgdn_normal.png);}""QPushButton:pressed{background-image: url(./skin/default/bt_pgdn_press.png);}");
    ...
    ui->le_page->setStyleSheet("QLineEdit{background-color:transparent;}""QLineEdit{background-image: url(./skin/default/le_data_jump.png);}");
    ui->le_page->hide();
...
void QQTCreateSysEvent(QString content, QString status)
{
