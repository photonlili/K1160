    ...
    m_bFlag(true)
{
    ...
    {
        m_pSerialClean = K1160SerialInst();
    }
    InitOCX();
    InitSings();
}
...
void QCleanForm::InitOCX()
{
    ...
    m_pLbjieshoubei->setStyleSheet("QLabel{background-color:transparent;}""QLabel{background-image: url(./skin/default/bt_check_normal.png);}");

    m_pLbhuansuan = new QMLabel(this);
    m_pLbhuansuan->setGeometry(104,157,39, 39);
    m_pLbhuansuan->setStyleSheet("QLabel{background-color:transparent;}""QLabel{background-image: url(./skin/default/bt_check_normal.png);}");

    m_pLbpengsuan = new QMLabel(this);
    m_pLbpengsuan->setGeometry(104,239,39, 39);
    m_pLbpengsuan->setStyleSheet("QLabel{background-color:transparent;}""QLabel{background-image: url(./skin/default/bt_check_normal.png);}");

    m_pLbxiaohuaguan = new QMLabel(this);
    m_pLbxiaohuaguan->setGeometry(503,75,39, 39);
    m_pLbxiaohuaguan->setStyleSheet("QLabel{background-color:transparent;}""QLabel{background-image: url(./skin/default/bt_check_normal.png);}");

    m_pLbjianguan = new QMLabel(this);
    m_pLbjianguan->setGeometry(503,157,39, 39);
    m_pLbjianguan->setStyleSheet("QLabel{background-color:transparent;}""QLabel{background-image: url(./skin/default/bt_check_normal.png);}");

    m_pLbyiqi = new QMLabel(this);
    m_pLbyiqi->setGeometry(503,239,39, 39);
    m_pLbyiqi->setStyleSheet("QLabel{background-color:transparent;}""QLabel{background-image: url(./skin/default/bt_check_normal.png);}");
    ...
    ui->pb_clean_start->setStyleSheet("QPushButton{background-color:transparent;background-image: url(./skin/default/bt_start_normal.png)}""QPushButton:hover{background-image: url(./skin/default/bt_start_normal.png);}""QPushButton:pressed{background-image: url(./skin/default/bt_start_press.png);}");
...
void QCleanForm::jieshoubei()
{
    if(true == m_bjieshoubei)
     {
        m_pLbjieshoubei->setStyleSheet("QLabel{background-color:transparent;}""QLabel{background-image: url(./skin/default/bt_check_press.png);}");
        m_bjieshoubei = false;
...
void QCleanForm::huansuan()
{
    if(true == m_bhuansuan)
     {
        m_pLbhuansuan->setStyleSheet("QLabel{background-color:transparent;}""QLabel{background-image: url(./skin/default/bt_check_press.png);}");
        m_bhuansuan = false;
...
void QCleanForm::pengsuan()
{
    if(true == m_bpengsuan)
     {
        m_pLbpengsuan->setStyleSheet("QLabel{background-color:transparent;}""QLabel{background-image: url(./skin/default/bt_check_press.png);}");
        m_bpengsuan = false;
...
void QCleanForm::xiaohuaguan()
{
    if(true == m_bxiaohuaguan)
     {
        m_pLbxiaohuaguan->setStyleSheet("QLabel{background-color:transparent;}""QLabel{background-image: url(./skin/default/bt_check_press.png);}");
...
void QCleanForm::jianguan()
{
    if(true == m_bjianguan)
     {
        m_pLbjianguan->setStyleSheet("QLabel{background-color:transparent;}""QLabel{background-image: url(./skin/default/bt_check_press.png);}");
        m_bjianguan = false;
...
void QCleanForm::yiqi()
{
    if(true == m_byiqi)
     {
        m_pLbyiqi->setStyleSheet("QLabel{background-color:transparent;}""QLabel{background-image: url(./skin/default/bt_check_press.png);}");
        m_byiqi = false;
