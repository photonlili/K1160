...
void QUserForm::InitOCX()
{
    ...
    m_plbhead1->setStyleSheet("QLabel{background-color:transparent;}""QLabel{background-image: url(./skin/default/bt_head1_normal.png);}");

    m_plbhead2 = new QMLabel(this);
    m_plbhead2->setGeometry(606,94,86, 86);
    m_plbhead2->setStyleSheet("QLabel{background-color:transparent;}""QLabel{background-image: url(./skin/default/bt_head2_normal.png);}");

    m_plbhead3 = new QMLabel(this);
    m_plbhead3->setGeometry(696,94,86, 86);
    m_plbhead3->setStyleSheet("QLabel{background-color:transparent;}""QLabel{background-image: url(./skin/default/bt_head3_normal.png);}");

    m_plbhead4 = new QMLabel(this);
    m_plbhead4->setGeometry(786,94,86, 86);
    m_plbhead4->setStyleSheet("QLabel{background-color:transparent;}""QLabel{background-image: url(./skin/default/bt_head4_normal.png);}");
    ...
    if(head == "head1")
    {
        ...
        m_plbhead1->setStyleSheet("QLabel{background-color:transparent;}""QLabel{background-image: url(./skin/default/bt_head1_press.png);}");
    }
    else if(head == "head2")
    {
        emit emitHeadIndex(2);
        m_plbhead2->setStyleSheet("QLabel{background-color:transparent;}""QLabel{background-image: url(./skin/default/bt_head2_press.png);}");
    }
    else if(head == "head3")
    {
        emit emitHeadIndex(3);
        m_plbhead3->setStyleSheet("QLabel{background-color:transparent;}""QLabel{background-image: url(./skin/default/bt_head3_press.png);}");
}
    else if(head == "head4")
    {
        emit emitHeadIndex(4);
        m_plbhead4->setStyleSheet("QLabel{background-color:transparent;}""QLabel{background-image: url(./skin/default/bt_head4_press.png);}");
}
    m_plbtheme1 = new QMLabel(this);
    m_plbtheme1->setGeometry(67,407,79, 59);
    m_plbtheme1->setStyleSheet("QLabel{background-color:transparent;}""QLabel{background-image: url(./skin/default/bt_theme1_normal.png);}");

    m_plbtheme2 = new QMLabel(this);
    m_plbtheme2->setGeometry(158,407,79, 59);
    m_plbtheme2->setStyleSheet("QLabel{background-color:transparent;}""QLabel{background-image: url(./skin/default/bt_theme2_normal.png);}");

    m_plbtheme3 = new QMLabel(this);
    m_plbtheme3->setGeometry(249,407,79, 59);
    m_plbtheme3->setStyleSheet("QLabel{background-color:transparent;}""QLabel{background-image: url(./skin/default/bt_theme3_normal.png);}");

    m_plbtheme4 = new QMLabel(this);
    m_plbtheme4->setGeometry(340,407,79, 59);
    m_plbtheme4->setStyleSheet("QLabel{background-color:transparent;}""QLabel{background-image: url(./skin/default/bt_theme4_normal.png);}");

    QString theme = set.value("ThemePic").toString();
    if(theme == "theme1")
    {
        emit emitScreenIndex(1);
        m_plbtheme1->setStyleSheet("QLabel{background-color:transparent;}""QLabel{background-image: url(./skin/default/bt_theme1_press.png);}");
    }
    else if(theme == "theme2")
    {
        emit emitScreenIndex(2);
        m_plbtheme2->setStyleSheet("QLabel{background-color:transparent;}""QLabel{background-image: url(./skin/default/bt_theme2_press.png);}");
    }
    else if(theme == "theme3")
        {
            emit emitScreenIndex(3);
        m_plbtheme3->setStyleSheet("QLabel{background-color:transparent;}""QLabel{background-image: url(./skin/default/bt_theme3_press.png);}");
    }
    else if(theme == "theme4")
        {
            emit emitScreenIndex(4);
        m_plbtheme4->setStyleSheet("QLabel{background-color:transparent;}""QLabel{background-image: url(./skin/default/bt_theme4_press.png);}");
    }
    ...
    ui->pb_user_logout->setStyleSheet("QPushButton{background-color:transparent;background-image: url(./skin/default/bt_logout_normal.png)}""QPushButton:hover{background-image: url(./skin/default/bt_logout_normal.png);}""QPushButton:pressed{background-image: url(./skin/default/bt_logout_press.png);}");

    ui->pb_logout_save->setFlat(true);
    //ui->pb_logout_save->setFocusPolicy(Qt::NoFocus);
    ui->pb_logout_save->setGeometry(761,592,144,48);
    ui->pb_logout_save->setStyleSheet("QPushButton{background-color:transparent;background-image: url(./skin/default/bt_savebig_normal.png)}""QPushButton:hover{background-image: url(./skin/default/bt_savebig_normal.png);}""QPushButton:pressed{background-image: url(./skin/default/bt_savebig_press.png);}");

    ui->ed_user_oldpasswd->setGeometry(142,75,291, 35);
    ui->ed_user_oldpasswd->setStyleSheet("QLineEdit{background-color:transparent;}""QLineEdit{background-image: url(./skin/default/ed_line_big.png);font-size:17px}");
    ui->ed_user_oldpasswd->setEchoMode (QLineEdit::Password);

    ui->ed_user_newpasswd->setGeometry(142,121,291, 35);
    ui->ed_user_newpasswd->setStyleSheet("QLineEdit{background-color:transparent;}""QLineEdit{background-image: url(./skin/default/ed_line_big.png);font-size:17px}");
    ui->ed_user_newpasswd->setEchoMode (QLineEdit::Password);

    ui->ed_user_comfirepasswd->setGeometry(142,167,291, 35);
    ui->ed_user_comfirepasswd->setStyleSheet("QLineEdit{background-color:transparent;}""QLineEdit{background-image: url(./skin/default/ed_line_big.png);font-size:17px}");
...
void QUserForm::InitSings()
{
    ...
    //todo:
    connect(this, SIGNAL(emitScreenIndex(int)), 0, SLOT(changescreen(int)));
    connect(this, SIGNAL(emitHeadIndex(int)), 0, SLOT(changehead(int)));
    ...
    if(true == m_bhead1)
     {
         ...
         set.sync();
         QQTMainForm* w = (QQTMainForm*)QQTObjectFactory::registedObject("QQTMainForm");
         w->setHead();
     }
     else
     {
...
{
    if( QQTMsgBox::Rejected == QQTMsgBox::question(this, "确认注销用户，登出系统？"))
        return;
