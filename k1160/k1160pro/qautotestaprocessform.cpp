...
*/
    ...
    ui->pb_autotestpt_back->setStyleSheet("QPushButton{background-color:transparent;background-image: url(./skin/default/bt_back_big_normal.png)}""QPushButton:hover{background-image: url(./skin/default/bt_back_big_normal.png);}""QPushButton:pressed{background-image: url(./skin/default/bt_back_big_press.png);}");
    ...
    ui->pb_autotestpt_naoh->setStyleSheet("QPushButton{background-color:transparent;background-image: url(./skin/default/bt_naoh_normal.png)}""QPushButton:hover{background-image: url(./skin/default/bt_naoh_normal.png);}""QPushButton:pressed{background-image: url(./skin/default/bt_naoh_press.png);}");
...
void QAutoTestaProcessForm::CalNitrogen()
{
    ...
    QAutoTest* pAutoTest = (QAutoTest*)QQTObjectFactory::registedObject("QAutoTest");
