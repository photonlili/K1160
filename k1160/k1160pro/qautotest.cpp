...
void QAutoTest::InitOCX()
{
    ...
    ui->ed_autotest_name->setStyleSheet("QLineEdit{background-color:transparent;}""QLineEdit{background-image: url(./skin/default/ed_line_big.png);font-size:17px}");
    ...
    ui->ed_autotest_pihao->setStyleSheet("QLineEdit{background-color:transparent;}""QLineEdit{background-image: url(./skin/default/ed_line_big.png);font-size:17px}");
    ...
    ui->ed_autotest_yangpinliang->setStyleSheet("QLineEdit{background-color:transparent;}""QLineEdit{background-image: url(./skin/default/ed_line.png);font-size:17px}");
    ...
    ui->ed_autotest_tiji->setStyleSheet("QLineEdit{background-color:transparent;}""QLineEdit{background-image: url(./skin/default/ed_line_big.png);font-size:17px}");

    ui->ed_autotest_nongdu->setGeometry(145, y + dy * 6, 291, 35);
    //ui->ed_autotest_nongdu->setFocusPolicy(Qt::NoFocus);
    ui->ed_autotest_nongdu->setStyleSheet("QLineEdit{background-color:transparent;}""QLineEdit{background-image: url(./skin/default/ed_line_big.png);font-size:17px}");
    ...
    ui->ed_autotest_beizhu->setStyleSheet("QLineEdit{background-color:transparent;}""QLineEdit{background-image: url(./skin/default/ed_line_big.png);font-size:17px}");
    ...
    ui->pb_autotest_pici->setStyleSheet("QPushButton{background-color:transparent;background-image: url(./skin/default/bt_pici_normal.png)}""QPushButton:hover{background-image: url(./skin/default/bt_pici_normal.png);}""QPushButton:pressed{background-image: url(./skin/default/bt_pici_press.png);}");
    ...
    ui->pb_autotest_start->setStyleSheet("QPushButton{background-color:transparent;background-image: url(./skin/default/bt_start_normal.png)}""QPushButton:hover{background-image: url(./skin/default/bt_start_normal.png);}""QPushButton:pressed{background-image: url(./skin/default/bt_start_press.png);}");
    ...
    m_pLbxiaohuaguanpaifei->setStyleSheet("QLabel{background-color:transparent;}""QLabel{background-image: url(./skin/default/lab_yes.png);}");
    ...
    m_pLbjieshoubeipaifei->setStyleSheet("QLabel{background-color:transparent;}""QLabel{background-image: url(./skin/default/lab_no.png);}");
...
{
    m_pLbAutoTest->setStyleSheet("QMLabel{background-color:transparent;}""QMLabel{background-image: url(./skin/default/lab_autotest_auto_press.png);}");
    m_pLbManualTest->setStyleSheet("QLabel{background-color:transparent;}""QLabel{background-image: url(./skin/default/lab_autotest_manual.png);}");
    m_pLbClean->setStyleSheet("QLabel{background-color:transparent;}""QLabel{background-image: url(./skin/default/lab_autotest_normal.png);}");
}

void QAutoTest::ManualTestDlg()
{
    m_pLbAutoTest->setStyleSheet("QMLabel{background-color:transparent;}""QMLabel{background-image: url(./skin/default/lab_autotest_auto_normal.png);}");
    m_pLbManualTest->setStyleSheet("QLabel{background-color:transparent;}""QLabel{background-image: url(./skin/default/lab_autotest_manual_press.png);}");
    m_pLbClean->setStyleSheet("QLabel{background-color:transparent;}""QLabel{background-image: url(./skin/default/lab_autotest_normal.png);}");
}
...
void QAutoTest::CleanDlg()
{
    m_pLbAutoTest->setStyleSheet("QMLabel{background-color:transparent;}""QMLabel{background-image: url(./skin/default/lab_autotest_auto_normal.png);}");
    m_pLbManualTest->setStyleSheet("QLabel{background-color:transparent;}""QLabel{background-image: url(./skin/default/lab_autotest_manual.png);}");
    m_pLbClean->setStyleSheet("QLabel{background-color:transparent;}""QLabel{background-image: url(./skin/default/lab_autotest_clean_press.png);}");
}
...
void QAutoTest::on_cb_autotest_fangfamingcheng_currentIndexChanged(const QString &arg1)
{
    ...
    {
        m_pLbxiaohuaguanpaifei->setStyleSheet("QLabel{background-color:transparent;}""QLabel{background-image: url(./skin/default/lab_no.png);}");

    }

    if(0 == strlist.at(12).toInt())
    {
        m_pLbjieshoubeipaifei->setStyleSheet("QLabel{background-color:transparent;}""QLabel{background-image: url(./skin/default/lab_yes.png);}");
    }
    else
    {
        m_pLbjieshoubeipaifei->setStyleSheet("QLabel{background-color:transparent;}""QLabel{background-image: url(./skin/default/lab_no.png);}");
