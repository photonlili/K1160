...
void QSettingMethodForm::InitOCX()
{
    ...
    ui->pb_settingmethod_pgup->setStyleSheet("QPushButton{background-color:transparent;background-image: url(./skin/default/bt_pgup_normal.png)}""QPushButton:hover{background-image: url(./skin/default/bt_pgup_normal.png);}""QPushButton:pressed{background-image: url(./skin/default/bt_pgup_press.png);}");
    ...
    ui->pb_settingmethod_pgdn->setStyleSheet("QPushButton{background-color:transparent;background-image: url(./skin/default/bt_pgdn_normal.png)}""QPushButton:hover{background-image: url(./skin/default/bt_pgdn_normal.png);}""QPushButton:pressed{background-image: url(./skin/default/bt_pgdn_press.png);}");
    ...
    ui->pb_settingmethod_delete->setStyleSheet("QPushButton{background-color:transparent;background-image: url(./skin/default/bt_delete_normal.png)}""QPushButton:hover{background-image: url(./skin/default/bt_delete_normal.png);}""QPushButton:pressed{background-image: url(./skin/default/bt_delete_press.png);}");
    ...
    ui->pb_settingmethod_add->setStyleSheet("QPushButton{background-color:transparent;background-image: url(./skin/default/bt_add_normal.png)}""QPushButton:hover{background-image: url(./skin/default/bt_add_normal.png);}""QPushButton:pressed{background-image: url(./skin/default/bt_add_press.png);}");
    ...
    ui->pb_settingmethod_save->setStyleSheet("QPushButton{background-color:transparent;background-image: url(./skin/default/bt_save_normal.png)}""QPushButton:hover{background-image: url(./skin/default/bt_save_normal.png);}""QPushButton:pressed{background-image: url(./skin/default/bt_save_press.png);}");
    ...
    ui->pb_settingmethod_colud->setStyleSheet("QPushButton{background-color:transparent;background-image: url(./skin/default/bt_cloud_normal.png)}""QPushButton:hover{background-image: url(./skin/default/bt_cloud_normal.png);}""QPushButton:pressed{background-image: url(./skin/default/bt_cloud_press.png);}");
    ui->pb_settingmethod_colud->setHidden(true);

    //edit
    ui->le_settingmethod_mingcheng->setGeometry(540,72,291, 35);
    ui->le_settingmethod_mingcheng->setStyleSheet("QLineEdit{background-color:transparent;}""QLineEdit{background-image: url(./skin/default/ed_line_big.png);}");
    ...
    ui->le_settingmethod_xishu->setStyleSheet("QLineEdit{background-color:transparent;}""QLineEdit{background-image: url(./skin/default/ed_line_big.png);}");
    ...
    ui->le_settingmethod_pengsuan->setStyleSheet("QLineEdit{background-color:transparent;}""QLineEdit{background-image: url(./skin/default/ed_line_big.png);}");
    ui->le_settingmethod_pengsuan->setValidator(v1);

    ui->le_settingmethod_xishishui->setGeometry(540,216,291, 35);
    ui->le_settingmethod_xishishui->setStyleSheet("QLineEdit{background-color:transparent;}""QLineEdit{background-image: url(./skin/default/ed_line_big.png);}");
    ui->le_settingmethod_xishishui->setValidator(v1);

    ui->le_settingmethod_jian->setGeometry(540,264,291, 35);
    ui->le_settingmethod_jian->setStyleSheet("QLineEdit{background-color:transparent;}""QLineEdit{background-image: url(./skin/default/ed_line_big.png);}");
    ui->le_settingmethod_jian->setValidator(v1);

    ui->le_settingmethod_zhengliu->setGeometry(540,312, 188,35);
    ui->le_settingmethod_zhengliu->setStyleSheet("QLineEdit{background-color:transparent;}""QLineEdit{background-image: url(./skin/default/ed_line.png);}");
    ...
    ui->le_settingmethod_liuliang->setStyleSheet("QLineEdit{background-color:transparent;}""QLineEdit{background-image: url(./skin/default/ed_line_big.png);}");
    ...
    m_pLbjieshoubei->setStyleSheet("QLabel{background-color:transparent;}""QLabel{background-image: url(./skin/default/bt_no.png);}");

    m_pLbxiaohuaguan = new QMLabel(this);
    m_pLbxiaohuaguan->setGeometry(640,502,78, 29);
    m_pLbxiaohuaguan->setStyleSheet("QLabel{background-color:transparent;}""QLabel{background-image: url(./skin/default/bt_no.png);}");
...
void QSettingMethodForm::jieshoubei()
{
    if(true == m_bjieshoubei)
     {
         m_pLbjieshoubei->setStyleSheet("QLabel{background-color:transparent;}""QLabel{background-image: url(./skin/default/bt_off.png);}");
         m_bjieshoubei = false;
     }
     else
     {
...
void QSettingMethodForm::xiaohuaguan()
{
   if(true == m_bxiaohuaguan)
    {
        m_pLbxiaohuaguan->setStyleSheet("QLabel{background-color:transparent;}""QLabel{background-image: url(./skin/default/bt_off.png);}");
