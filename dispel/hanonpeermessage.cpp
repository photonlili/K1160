...
HanonPeerMessage::HanonPeerMessage(QObject *parent) :
    QObject(parent)
{
    m_Head = _PEER_HEAD;
...
void HanonPeerMessage::translate()
{
...
quint16 HanonPeerMessage::parseBlockSize(const QByteArray &netData)
{
...
void HanonPeerMessage::parse(const QByteArray &netData)
{
...
void HanonPeerMessage::pack(QByteArray &netData)
{
    netData << head();
    netData << size();
    netData << cmd();
...
void QQTConnC51Struct::pack(QByteArray &l)
{
    setCmd(_PEER_CONC51);
    translate();
    HanonPeerMessage::pack(l);
}


void QQTCmd2C51Ack::parse(const QByteArray &l)
{
    HanonPeerMessage::parse(l);
}


void QQTHeatStandardStruct::pack(QByteArray &l)
{
...
void QQTPauseStruct::pack(QByteArray &l)
{
    setCmd(_PEER_PAUSE);
    translate();
    HanonPeerMessage::pack(l);
...
void QQTStopStruct::pack(QByteArray &l)
{
    setCmd(_PEER_STOP);
    translate();
    HanonPeerMessage::pack(l);
...
void QQTHeatPressStruct::pack(QByteArray &l)
{
...
void QQTHeatRAMPStruct::pack(QByteArray &l)
{
...
void QQTHeatExtractStruct::pack(QByteArray &l)
{
